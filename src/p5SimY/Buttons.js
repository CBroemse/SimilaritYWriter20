function addButtons() {
	...
	input.position(width / 2 - input.width / 2, height - 400);
	...
	examples = {
		"y*(y-1)^y = -0.3*(x-1)^2 - 0.3*(z-1)^2 + 15": 3,
		"y*(x)^y = -0.3*(x-1)^2 - 0.3*(z-1)^2 + 15": 3,
		"x*(y-1)^z = -0.3*(x-1)^2 - 0.3*(z-1)^2 + 15": 3,
		"x*(y-1)^z = -0.3*(x-1)^2 - 0.3*y*(z-1)^2 + x": 3,
		"x*y^z = -0.3*(x-1)^2 - 0.3*(z-1)^2 + 15*z": 3,
		"x*y^z = -0.3*(x-1)^3 - 0.3*(z-1)^2 + 15*z^2": 3,
		"y = x^2 + z^2": 0.1,
		"y = x^2 * z^2": 0.0002,
		"y = sin(x+z)": 10,
		"y = log(x^2 + z^2)": 15,
